...
mkdir -p slurm_OUT_binding_site_last_frame
exec > "slurm_OUT_binding_site_last_frame/${PDB_ID}.out" 2>&1

module load Python/3.11.5
#python3 get_binding_site.py 1FO0
python3 get_binding_site_last_frame.py "${PDB_ID}"
