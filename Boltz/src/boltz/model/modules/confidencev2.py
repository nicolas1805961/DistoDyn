...
class ConfidenceModule(nn.Module):
    ...
    def forward(
        ...
        out_dict['bin_edges'] = self.boundaries
        return out_dict
...
class ConfidenceHeads(nn.Module):
    ...
    def forward(
        ...
        out_dict = dict(
            ...
            logits=pred_distogram_logits[0],
            prob_contact=prob_contact[0]
        )
        ...
        try:
            ...
            out_dict["logits"] = pred_distogram_logits[0]
            out_dict["prob_contact"] = prob_contact[0]
            ...
            out_dict["logits"] = torch.zeros_like(complex_plddt)
            out_dict["prob_contact"] = torch.zeros_like(complex_plddt)
